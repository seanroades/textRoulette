...
const Roulette = () => {
  ...
  const [textArray, setTextArray] = useState([
    ...
    "MFW I eat the pussy so good you punch me in the back of the head.",
    "Got my fishing rods lined up, cooler is full of beer, and boat is in the water. See you at the dock in 20.",
    "Can I find your pot o' gold tonight?",
    "Heading off to bed now, will talk to you tomorrow, love you x.",
    "He passed away early this morning. It was sudden, the doctors say it was in his sleep and peaceful.",
    "We will go clothes shopping after I get off work.",
    "I love the way your cock feels in my mom.",
    "I love you.",
    "Do you think you can handle being with someone as sexually aggressive as I am?",
    "Mate, I've just met Gemma for lunch and I've got jizz all up my fucking T-shirt.",
    "Don't be a little bitch",
    "Cool! Send me a pervert!",
    "I don’t think I can do this anymore, it’s exhausting.",
...
"k been ok - on hols now! Yes on for a bit of a run. Forgot that i have hairdressers appointment at four so need to get home n shower beforehand. Does that cause prob for u?",
...
"I‰Û÷m parked next to a MINI!!!! When are you coming in today do you think?",
"Yup",
...
"I‰Û÷ll have a look at the frying pan in case it‰Û÷s cheap or a book perhaps. No that‰Û÷s silly a frying pan isn‰Û÷t likely to be a book",
...
"Got it. Seventeen pounds for seven hundred ml ‰ÛÒ hope ok.",
...
"Allo! We have braved the buses and taken on the trains and triumphed. I mean we‰Û÷re in b‰Û÷ham. Have a jolly good rest of week",
...
"Just got up. have to be out of the room very soon. ‰Û_. i hadn't put the clocks back til at 8 i shouted at everyone to get up and then realised it was 7. wahay. another hour in bed.",
...
"Black shirt n blue jeans... I thk i c Ì_...",
...
"I don't know, same thing that's wrong everyso often, he panicks starts goin on bout not bein good enough ‰Û_",
...
"Ya! when are Ì_ taking ure practical lessons? I start in june..  ",
"That's good, because I need drugs",
"Stupid.its not possible",
"Can Ì_ all decide faster cos my sis going home liao..",
...
"Just sent you an email ‰ÛÒ to an address with incomm in it, is that right?",
...
"Ah, well that confuses things, doesn‰Û÷t it?",
...
"Fighting with the world is easy, u either win or lose bt fightng with some1 who is close to u is dificult if u lose - u lose if u win - u still lose.",
"Am watching house ‰ÛÒ very entertaining ‰ÛÒ am getting the whole hugh laurie thing ‰ÛÒ even with the stick ‰ÛÒ indeed especially with the stick.",
"Thought praps you meant another one. Goodo! I'll look tomorrow ",
"Hi Jon, Pete here, Ive bin 2 Spain recently & hav sum dinero left, Bill said u or ur åÔrents mayb interested in it, I hav 12,000pes, so around å£48, tb, James.",
...
"IåÕm cool ta luv but v.tired 2 cause i have been doin loads of planning all wk, we have got our social services inspection at the nursery! Take care & spk sn x.",
...
"Do Ì_ all wan 2 meet up n combine all the parts? How's da rest of da project going?",
...
"Or Ì_ go buy wif him then i meet Ì_ later can?",
...
"Yes but can we meet in town cos will go to gep and then home. You could text at bus stop. And don't worry we'll have finished by march ‰Û_ ish!",
"I had askd u a question some hours before. Its answer",
...
"Yes obviously, but you are the eggs-pert and the potato head‰Û_ Speak soon! ",
...
"ÌÏ dun wan to watch infernal affair?",
...
"You stayin out of trouble stranger!!saw Dave the other day heåÕs sorted now!still with me bloke when u gona get a girl MR!ur mum still Thinks we will get 2GETHA!",
...
"‰Û_ and don‰Û÷t worry we‰Û÷ll have finished by march ‰Û_ ish!",
...
// "Bill, as in: Are there any letters for me. i‰Ûªm expecting one from orange that isn‰Ûªt a bill but may still say orange on it.",
...
// "Ha. You don‰Û÷t know either. I did a a clever but simple thing with pears the other day, perfect for christmas.",
...
// "Ok... U enjoy ur shows...",
// "Anything...",
// "Where wuld I be without my baby? The thought alone mite break me and I donåÕt wanna go crazy but everyboy needs his lady xxxxxxxx",
...
// "Cos darren say Ì_ considering mah so i ask Ì_...",
...
// "I wait 4 Ì_ inside da car park...",
...
// "Dunno lei Ì_ all decide lor. How abt leona? Oops i tot ben is going n i msg him.",
...
// "Okie Ì_ wan meet at bishan? Cos me at bishan now. I'm not driving today.",
// "Oh ho. Is this the first time u use these type of words",
...
// "Ok... The theory test? when are Ì_ going to book? I think it's on 21 may. Coz thought wanna go out with jiayin. But she isnt free",
...
// "I think I‰Û÷m waiting for the same bus! Inform me when you get there, if you ever get there.",
...
// "Hi Petey!noiåÕm ok just wanted 2 chat coz avent spoken 2 u 4 a long time-hope ur doin alrite.have good nit at js love ya am.x",
...
// "When did i use soc... I use it only at home... ÌÏ dunno how 2 type it in word ar...",
...
// "Oh...i asked for fun. Haha...take care. Ì_",
...
// "It‰Û÷s å£6 to get in, is that ok?",
...
// "Otherwise had part time job na-tuition..",
// "ÌÏ mean it's confirmed... I tot they juz say oni... Ok then... ",
// "Okie",
...
// "Yeah whatever lol",
// "Today is ACCEPT DAY..U Accept me as? Brother Sister Lover Dear1 Best1 Clos1 Lvblefrnd Jstfrnd Cutefrnd Lifpartnr Belovd Swtheart Bstfrnd No rply means enemy",
// "Ard 530 lor. I ok then message Ì_ lor.",
// "Ok. C u then.",
// "Eh ur laptop got no stock lei... He say mon muz come again to take a look c got a not...",
// "No need to ke qi... ÌÏ too bored izzit y suddenly thk of this...",
...
// "That's the trouble with classes that go well - you're due a dodgey one ‰Û_ Expecting mine tomo! See you for recovery, same time, same place ",
...
// "Roger that. We‰Û÷re probably going to rem in about 20",
...
// "I think just yourself ‰Û_Thanks and see you tomo",
...
// "What you doing?how are you?",
// "Sure thing big man. i have hockey elections at 6, shouldn‰Û÷t go on longer than an hour though",
...
// "Just got to  &lt;#&gt;",
// "Good! No, don‰Û÷t need any receipts‰ÛÓwell done! (‰Û_) Yes, please tell . What‰Û÷s her number, i could ring her",
// "Ever green quote ever told by Jerry in cartoon \A Person Who Irritates u Always Is the one Who Loves u Vry Much But Fails to Express It...!..!! :-) :-) gud nyt"",
...
// "Y bishan lei... I tot Ì_ say lavender? ",
...
// "Ok i msg u b4 i leave my house.",
// "Still at west coast... Haiz... ÌÏ'll take forever to come back...",
...
// "Okey dokey, i‰Û÷ll be over in a bit just sorting some stuff out.",
// "Don no da:)whats you plan?",
// "Yes fine ",
// "WIN: We have a winner! Mr. T. Foley won an iPod! More exciting prizes soon, so keep an eye on ur mobile or visit www.win-82050.co.uk",
...
// "Big brother‰Û÷s really scraped the barrel with this shower of social misfits",
...
// "Forgot to tell Ì_ smth.. Can Ì_ like number the sections so that it's clearer..",
...
// "Er, hello, things didn‰Û÷t quite go to plan ‰ÛÒ is limping slowly home followed by aa and with exhaust hanging off",
...
// "Hi dis is yijue i would be happy to work wif Ì_ all for gek1510...",
...
// "Wanna do some art?! :D",
// "Just hopeing that wasn‰Û÷t too pissed up to remember and has gone off to his sisters or something!",
// "Got what it takes 2 take part in the WRC Rally in Oz? U can with Lucozade Energy! Text RALLY LE to 61200 (25p), see packs or lucozade.co.uk/wrc & itcould be u!",
...
// "We made it! Eta at taunton is 12:30 as planned, hope that‰Û÷s still okday?! Good to see you! :-xx",
...
// "Aiya we discuss later lar... Pick Ì_ up at 4 is it?",
// "Hey happy birthday...",
...
// "I'm in school now n i'll be in da lab doing some stuff give me a call when Ì_ r done.",
// "Oh k. . I will come tomorrow",
...
// "Spook up your mob with a Halloween collection of a logo & pic message plus a free eerie tone, txt CARD SPOOK to 8007 zed 08701417012150p per logo/pic",
// "I like cheap! But i‰Û÷m happy to splash out on the wine if it makes you feel better..",
...
// "Guai... ÌÏ shd haf seen him when he's naughty... ÌÏ so free today? Can go jogging...",
// "Aiyo cos i sms Ì_ then Ì_ neva reply so i wait 4 Ì_ to reply lar. I tot Ì_ havent finish ur lab wat.",
...
// "HARD BUT TRUE: How much you show &amp;  express your love to someone....that much it will hurt when they leave you or you get seperated...!Žö´‰Ó_??‹Û¬ud evening...",
...
"Shall I bring us a bottle of wine to keep us amused? Only joking! I‰Û÷ll bring one anyway",
...
"Ok lor Ì_ reaching then message me.",
...
"I went to project centre",
"It‰Û÷s reassuring, in this crazy world.",
...
"Rofl. Its true to its name"
  ...
  const [randomText, setRandomText] = useState("Waiting for you to commit")
  const [randomPerson, setRandomPerson] = useState("Waiting for contact sync")
  ...
  const shareText = async () => {
    ...
    setRandomPerson(randomContact.name)
    if (randomContact != undefined) {
      if (randomContact.phoneNumbers && randomContact.phoneNumbers.length > 0 && randomContact.phoneNumbers[0].digits) {
        setNumber(randomContact.phoneNumbers[0].digits)
      }
    }
    console.log("SHARING")
    setRandomText(textArray[Math.floor(Math.random() * textArray.length)])
    try {
